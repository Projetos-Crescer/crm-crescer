...
{strip}
	<style>
		...
		.buttonBlue {
			background-image: linear-gradient(to bottom, #007bb6 0px, #007bb6 100%)
		}
		.ripples {
			position: absolute;
			top: 0;
			...
			<div class="loginDiv widgetHeight">
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							...
							<a class="forgotPasswordLink" style="color: #15c;">esqueceu a senha?</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						<div class="group">
							<input id="fusername" type="text" name="username" placeholder="Usuário" >
							<span class="bar"></span>
							<label>Usuário</label>
						</div>
						<div class="group">
						...
						<div class="group">
							...
							<span>Please enter details and submit<a class="forgotPasswordLink pull-right" style="color: #15c;">Voltar</a></span>
						</div>
					</form>
				</div>
			</div>
